    ...
    stage("Deploy") {
      ...
      steps {
        ...
        script {
            ...
            sshUserPrivateKey(credentialsId: 'ssh-key', sshKeyVariable: '')
            sh "ssh -i $SSH_KEY root@137.184.15.239 './deploy.sh'"
        }
      }
    }
